...
# Hyper parameters
hyper_parameters = {"lr0": 0.00001,  # initial learning rate
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(usage="\n\tpython train.py --config-file configs/yolov4m.yaml "
                                           "--data data/coco-evraz2.yaml")
    ...
    parser.add_argument("--config-file", type=str, default="configs/yolov4m.yaml",
                        help="Neural network profile path. (default: `configs/COCO-Detection/yolov5-small.yaml`)")
    parser.add_argument("--data", type=str, default="data/coco-evraz.yaml",
    ...
    parser.add_argument("--weights", type=str, default="weights/model_best-2021-10-30_23-09.pth",
